        ...
        implements Consumer<Renderer>
{
    ...
    static {
        CREATORS.put( "bottomleft", TextRenderer::bottomLeft );
        CREATORS.put( "bottomright", TextRenderer::bottomRight );
        CREATORS.put( "topleft", TextRenderer::topLeft );
        CREATORS.put( "topright", TextRenderer::topRight );
    }
    ...
    public static TextRenderer create( String type, String text, Color colour, Color background, Color border )
    {
    ...
    public TextRenderer( String text, Color colour, Color background, Color border )
    {
        this.text = " " + text.trim() + " ";
        this.colour = colour;
    ...
    public static TextRenderer topLeft( String text, Color color, Color background, Color border )
    {
        return new TextRenderer( text, color, background, border )
        {
            @Override
    ...
    public static TextRenderer bottomLeft( String text, Color color, Color background, Color border )
    {
        return new TextRenderer( text, color, background, border )
        {
            @Override
    ...
    public static TextRenderer topRight( String text, Color color, Color background, Color border )
    {
        return new TextRenderer( text, color, background, border )
        {
            @Override
    ...
    public static TextRenderer bottomRight( String text, Color color, Color background, Color border )
    {
        return new TextRenderer( text, color, background, border )
        {
            @Override
    ...
    public static interface Create
    {
        ...
        TextRenderer create( String text, Color color, Color background, Color border );
    }
}
